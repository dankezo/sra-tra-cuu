...
Ô **Lọc theo trạng thái** là dropdown đa lựa chọn (xanh / vàng / cam / xám) thay cho checkbox cũ “Hoạt chất ở VN”. Mặc định chỉ tick **Sẵn sàng dự thầu** (xanh): tân dược thương mại, hạn rõ, còn hiệu lực, kỳ cấp > 3 năm và còn hạn > 18 tháng, không khớp Danh mục 93. Vàng = hạn ngắn / kỳ ≤ 3 năm / đang nộp gia hạn; cam = khớp DM93 (CMO); xám = hết hạn / thu hồi / lịch sử. Có thể đổi tên nhãn (lưu localStorage), tooltip giải thích từng màu, và nút Chỉ lấy Xanh / Chọn tất cả / Xóa chọn. Không chọn tag nào thì không hiện kết quả. So sánh DAV cũng chỉ lấy hồ sơ theo các tag đang chọn.
