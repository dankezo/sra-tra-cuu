...
console.log('PASS: minimum granted three-year term, domestic exclusions, DAV registrant, component comparison and deduplication');
...
assert.ok(abrocto.every(a=>a.reason==='eligible'));
const base={...abrocto[0].record,issued:'2024-01-01',renewed:'',expiry:'2027-01-01'};
assert.equal(vn.assess(base,vn.SIMPLE_POLICY,asOf).reason,'eligible');
...
console.log('PASS: both Abrocto registrations, exactly three years, shorter term, expired and renewed terms');
